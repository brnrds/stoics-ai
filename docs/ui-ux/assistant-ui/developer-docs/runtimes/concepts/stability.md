...
## [What `unstable_` means](#what-unstable_-means)
...
## [Why we ship them](#why-we-ship-them)
...
## [Currently unstable APIs](#currently-unstable-apis)
...
## [When something stabilizes](#when-something-stabilizes)
...
- href
  ...
  https\://github.com/assistant-ui/assistant-ui/releases
...
ArchitectureThe three-layer runtime model.

- href

  /docs/runtimes/concepts/adapters

AdaptersThe shared adapter contracts.

- href

  /docs/runtimes/concepts/threads

ThreadsMulti-thread support patterns.